...
def _write_settings(config_dir: Path) -> None:
    ...
    # Inject a unique secret_key — placeholder comment in source file is replaced
...
class SearXNGManager:
    ...
    async def _start_container(self) -> bool:
        ...
        # Use bridge (default) so SearXNG is reachable on host via localhost:8080.
        ...
        logger.info(f"SearXNG container started: {CONTAINER_NAME} ({container_id})")
        return True
